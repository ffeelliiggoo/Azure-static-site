...
(function (html) {
  ...
  const functionApiApiUrl = "https://fn6ic.azurewebsites.net/api/Counter?code=rdWvT2wPweFyjQPes60zGfkygsOqzT6mikDOArCFX3DaAzFutaM0mQ%3D%3D";
  const localfunctionApi = "http://localhost:7071/api/Counter";
